      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center">
            <div 
              className={`relative w-80 h-96 bg-gradient-to-br from-slate-800 to-purple-900 rounded-3xl shadow-2xl transition-all duration-500 ${isHovered ? 'scale-105 rotate-2' : ''}`}
            ...
            >
              ...
              <div className="absolute inset-2 bg-black rounded-2xl">
                {/* Screen */}
                <div className="absolute inset-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center">
                  <span className="text-white font-bold text-xl">R14 AURA</span>
                </div>
              </div>
